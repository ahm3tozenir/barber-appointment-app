...
export const routes: Routes = [
  ...
  {
    path: 'admin/error/internal-server-error',
    ...
    children: [
      ...
      { path: 'home', component: AdminHomeComponent },
      {
        ...
        children: [
          ...
          {
            path: 'set-credentials/:userId',
            component: UserSetCredentialComponent,
          },
          {
            path: 'list-working-ranges/:userId',
            component: UserListWorkingRangeComponent,
          },
        ],
      },
